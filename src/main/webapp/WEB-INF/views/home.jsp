...
<div class="container-fluid">
  <div class="row">
    <!-- 사이드 메뉴 -->
	<div class="col-md-2">
	  <div class="bg-light border rounded p-3 shadow-sm" style="min-height: 100vh;">
	    <h5 class="fw-bold text-primary mb-4">📁 메뉴</h5>
	    <ul class="nav flex-column">
	      <li class="nav-item mb-2">
	        <a class="nav-link d-flex align-items-center menu-link" href="home.do">
	          🏠 <span class="ms-2">홈</span>
	        </a>
	      </li>
	      <li class="nav-item mb-2">
	        <a class="nav-link d-flex align-items-center menu-link" href="#">
	          🙋‍♂️ <span class="ms-2">마이페이지</span>
	        </a>
	      </li>
	      <c:if test="${user.authrtCd == '2'}">
	        <li class="nav-item mb-2">
	          <a class="nav-link d-flex align-items-center menu-link" href="adminBoardInsertPage.do">
	            📝 <span class="ms-2">글쓰기</span>
	          </a>
	        </li>
	      </c:if>
	      <li class="nav-item mb-2">
	        <a class="nav-link d-flex align-items-center menu-link" href="gisHome.do">
	          🗺️ <span class="ms-2">GIS Reflect</span>
	        </a>
	      </li>
	      <li class="nav-item mb-2">
	        <a class="nav-link d-flex align-items-center menu-link" href="gisOlHome.do">
	          🌐 <span class="ms-2">GIS OpenLayer</span>
	        </a>
	      </li>
	      <li class="nav-item mb-2">
	        <a class="nav-link d-flex align-items-center menu-link" href="rOne.do">
	          📌 <span class="ms-2">한국부동산원 OPEN API</span>
	        </a>
	      </li>
	      <li class="nav-item mb-2">
	        <a class="nav-link d-flex align-items-center menu-link" href="poke.do">
			  🎮 <span class="ms-2">포켓몬 도감 API 실습</span>
			</a>
	      </li>
